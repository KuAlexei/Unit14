package com.epam.ld.javabasics30.unit14.skils.consolidation.task01;
...
public class Library {
    ...
    public Library sortByPublishedYear() {
        return sortByCustomCondition(Comparator.comparing(Book::getYear));
    }
